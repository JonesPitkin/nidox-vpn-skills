...
- Аппаратная платформа и ограничения: [references/hardware.md](references/hardware.md).
- Установка и обновление: [references/installation.md](references/installation.md).
- Сброс, Failsafe Mode, TFTP и восстановление: [references/recovery.md](references/recovery.md).
- Индикаторы: [references/leds.md](references/leds.md).
- UART: [references/serial-console.md](references/serial-console.md).
- DSA-порты и VLAN: [references/vlan-and-ports.md](references/vlan-and-ports.md).
- Ревизии, ошибки и ограничения: [references/known-issues.md](references/known-issues.md).
- Podkop, sing-box, DNS и FakeIP: [references/podkop-on-wr3000s.md](references/podkop-on-wr3000s.md).
- Производительность, RAM, VPN-клиенты и NAT offload: [references/performance.md](references/performance.md).
