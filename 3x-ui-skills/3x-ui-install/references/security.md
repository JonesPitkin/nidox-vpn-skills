...
- [Official install.sh TLS flow](https://github.com/MHSanaei/3x-ui/blob/main/install.sh)
- [Official x-ui.sh firewall/SSL/IP-limit flow](https://github.com/MHSanaei/3x-ui/blob/main/x-ui.sh)
- [Docker entrypoint Fail2ban rules](https://github.com/MHSanaei/3x-ui/blob/main/DockerEntrypoint.sh)
